...
export default (variables = variable) => {
    ...
    return {
        ...
        '.itemHeader': {
            ...
            borderBottomWidth: 'ios' === platform ? variables.borderWidth : null,
            marginLeft: null,
            padding: variables.listItemPadding,
            paddingLeft: variables.listItemPadding + 5,
            paddingTop: 'ios' === platform ? variables.listItemPadding + 25 : undefined,
            paddingBottom: 'android' === platform ? variables.listItemPadding + 20 : undefined,
            flexDirection: 'row',
            borderColor: variables.listBorderColor,
            'NativeBase.Text': {
                fontSize: 14,
                color: 'ios' === platform ? undefined : variables.listNoteColor,
            },
        },
        '.itemDivider': {
        ...
        '.icon': {
            ...
            'NativeBase.Right': {
                ...
                'NativeBase.Switch': {
                    marginRight: 'ios' === Platform.OS ? undefined : -5,
                    alignSelf: null,
                },
                'NativeBase.PickerNB': {
                    ...pickerTheme(),
