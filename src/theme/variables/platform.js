...
export default {
    ...
    // FooterTab
    tabBarTextColor: 'ios' === platform ? '#6b6b6b' : '#b3c7f9',
    tabBarTextSize: 'ios' === platform ? 14 : 11,
    activeTab: 'ios' === platform ? '#007aff' : '#fff',
    sTabBarActiveTextColor: '#007aff',
    tabBarActiveTextColor: 'ios' === platform ? '#007aff' : '#fff',
    ...
    iosStatusbar: 'ios' === platform ? 'dark-content' : 'light-content',
    get statusBarColor() {
    ...
    subtitleColor: 'ios' === platform ? '#8e8e93' : '#FFF',
